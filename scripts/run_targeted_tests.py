...
tests_to_run = [
    ("core", ["python", "-m", "pytest", "tests/test_product_safety_and_draft.py", "tests/test_products.py", "tests/test_products_search_filters.py", "tests/test_avito_post_sale_deactivation.py", "-p", "no:warnings"]),
