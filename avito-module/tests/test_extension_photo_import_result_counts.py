...
def test_extension_photo_import_result_counts_and_partial_status(mock_post):
    """Verify bridge returns partial status if photos were received but Core imported 0 photos."""
    mock_resp = MagicMock()
    ...
    payload = {
        ...
        "listing": {
            ...
            "price": 6900,
            "photos": ["https://10.img.avito.st/image/1/1.fail.jpg"]
        }
    }
