...
def test_extension_download_is_current_version():
    ...
    assert any(v in res.headers.get("content-disposition", "") for v in ("0.2.53", "0.2.54", "0.2.55", "0.2.56", "0.2.57", "0.2.58", "0.2.59", "0.2.60", "0.2.61", "0.2.62", "0.2.63", "0.2.64", "0.2.65", "0.2.66"))
