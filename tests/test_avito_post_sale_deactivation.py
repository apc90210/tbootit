...
def test_extension_package_v0259_and_task_channel_helpers():
    ...
    with zipfile.ZipFile(ext_zip_path, "r") as zf:
        ...
        assert manifest_data["version"] in ("0.2.59", "0.2.60", "0.2.61", "0.2.62", "0.2.63", "0.2.64", "0.2.65")

        sw_code = zf.read("service_worker.js").decode("utf-8")
        assert any(v in sw_code for v in ("0.2.59", "0.2.60", "0.2.61", "0.2.62", "0.2.63", "0.2.64", "0.2.65"))
        ...
        assert any(v in content_code for v in ("0.2.59", "0.2.60", "0.2.61", "0.2.62", "0.2.63", "0.2.64", "0.2.65"))
