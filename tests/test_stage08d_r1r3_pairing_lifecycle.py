...
def test_fresh_code_redeem_success():
    ...
    assert status_data["version"] == "0.2.54"
...
def test_extension_package_version_and_dynamic_origin():
    """Verify Chrome extension source files include dynamic origin support and v0.2.54."""
    ...
    assert manifest["version"] == "0.2.54"
