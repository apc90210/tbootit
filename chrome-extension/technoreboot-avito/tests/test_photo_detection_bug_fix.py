...
ZIP_PATH = os.path.abspath("dist/technoreboot-avito-extension-0.2.46.zip")
ADMIN_ZIP_PATH = os.path.abspath("admin-shell/app/technoreboot-avito-extension-0.2.46.zip")
...
def test_extension_manifest_and_zip_version_0_2_46():
    """Verify manifest.json and built ZIP archives have version 0.2.46."""
